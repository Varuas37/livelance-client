const dummyOfferedFreelanceList = {
	data: [
		{
			id: "1",
			postedOn: "Jan 22, 2022",
			jobTitle: "Offered Job 1",
			jobDescription:
...
export function fetchdummyOfferedFreelanceList() {
	return dummyOfferedFreelanceList;
}
export function fetchDummyFreelanceById(id) {
	return {
		data: dummyOfferedFreelanceList.data.find(
