...
const EmployerHomeFeed = () => {
	...
	const [sidebarOpen, setSidebarOpen] = useState(false);
	const [curFreelancersList, setCurFreelancenrsList] = useState([]);
>>>>>>> 136ff2e52a86e0c019e985bdfbc1942c0ba135fd
...
=======
				<SearchAndProfileAvatar
					universalDataList={freelancersListForHomePage}
					dataList={curFreelancersList}
					setDataList={setCurFreelancenrsList}
...
=======
											{curFreelancersList && curFreelancersList.length > 0 ? (
												curFreelancersList.map((eachFreelancer) => {
>>>>>>> 136ff2e52a86e0c019e985bdfbc1942c0ba135fd
													return (
