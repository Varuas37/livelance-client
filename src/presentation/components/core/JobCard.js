    ...
    return (
        <li className="bg-white shadow overflow-hidden mt-5 px-4 py-4 sm:px-6 sm:rounded-md">
            ...
            <div className="w-full px-10 my-4 py-6 bg-white ">
                ...
                <div className="mt-2">
                    <a className="text-2xl text-gray-700 font-bold hover:text-gray-600" href="#">{data.jobTitle}</a>
                    ...
                    <div class='my-1 flex flex-wrap -m-1'>
                        {
                            data.skills.map((skill) => <>
                                <span className="m-1 bg-indigo-200 hover:bg-indigo-300 rounded-full px-2 font-bold text-sm leading-loose cursor-pointer" >{skill}</span>
                            </>)
                        }
                ...
                <div className="flex justify-between items-center mt-4">
                    ...
                    <div className="font-light text-gray-600 flex flex-row space-x-1">
                        ...
                        <span>{data.location},  {data.zipcode}</span>
                    </div>
                    <div>
...
JobCard.defaultProps = {
    data: {
        ...
        jobTitle: 'Job Title',
        jobDescription: 'Job Description. Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora expedita dicta totam aspernatur doloremque. Excepturi iste iusto eos enim reprehenderit nisi, accusamus delectus nihil quis facere in modi ratione libero!',
        skills: ['programming', 'web design', 'nodejs', 'sql', 'mobile development'],
        postedBy: 'Jeff',
        duration: '3 weeks',
        rate: '$35 / hr',
