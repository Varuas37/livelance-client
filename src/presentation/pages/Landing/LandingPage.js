...
const solutions = [
	...
	{
		name: "Live Chat",
		description: "Talk with our customer help desk 24hrs.",
		href: "#",
		icon: ChatAlt2Icon,
	},
	{
...
const features = [
	{
		...
		description:
			"The best and most effective way to get in touch with our customer support.",
		icon: InboxIcon,
	},
	{
	...
	},
	{
		name: "Spam Report",
		description:
			"Our dedicated team members are ready to deal with malicious and unsuspected emails .",
		icon: TrashIcon,
	},
	{
		name: "Compose in Markdown",
		description:
			"Our website content and photos created to be a user friendly.",
		icon: PencilAltIcon,
	},
	{
		name: "Team Reporting",
		description:
			"Our effective reporting management helps improve on our business decision.",
		icon: DocumentReportIcon,
	},
	{
		name: "Saved Replies",
		description:
			"For easy and quick recap to building a healthy customer relationship.",
		icon: ReplyIcon,
	},
	{
		name: "Email Commenting",
		description:
			"Updating and getting in touch with our customer in the timely manner.",
		icon: ChatAltIcon,
	},
	{
...
const metrics = [
	{
		...
		stat: "Events",
		emphasis: "",
		rest: "collaborating with small and upcoming business for healthy development .",
	},
	{
		id: 2,
		stat: "Market Target",
		emphasis: "States around the US",
		rest: "remote and non remotes cities.",
	},
	{
		id: 3,
		stat: "Customer Care",
		emphasis: "Customer satisfaction",
		rest: "meeting our customer Expectation is our goal.",
	},
	{
		id: 4,
		stat: "Customer Support",
		emphasis: "Problem Solving",
		rest: "raising issuing between clients and consumers are handled amicably.",
	},
];
							...
							<div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
								<div>
									...
									<div className="mt-6">
										...
										<p className="mt-4 text-lg text-gray-500">
											You can directly communicate with the freelancers on our
											websties. You can trust us with the service they provide.
				...
				<div className="bg-gradient-to-r from-purple-800 to-indigo-700">
					<div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
						...
						<p className="mt-4 max-w-3xl text-lg text-purple-200">
							For any kind of support and inquiry email,text or call us, we are
							available 24hrs.
						</p>
					...
					<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
						<div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
							<h2 className="text-sm font-semibold tracking-wide uppercase">
								<span className="bg-gradient-to-r from-purple-300 to-indigo-300 bg-clip-text text-transparent"></span>
							</h2>
							<p className="mt-3 text-3xl font-extrabold text-white">
								Get the best talent that will help grow your business
							</p>
							<p className="mt-5 text-lg text-gray-300">
								Working with our most reliable clients will help you build and
								advance your skills to greater heights .
							</p>
