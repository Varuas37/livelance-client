                                ...
                                <div>
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="mt-4 text-lg text-gray-500">
                                            Livelance connects you direcly with a freelance worker near your area. We have inbuilt chat system which allows for better communication between the employer and the employee.
                                        </p>
                                        <div className="mt-6">
                                            <a
                                                href="#"
                            ...
                            <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
                                <div>
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <p className="mt-4 text-lg text-gray-500">
                                            You can directly communicate with the freelancers on our websties. You can trust us with the service they provide. Freelancers with low reviews are removed.
                                        </p>
                                        <div className="mt-6">
                                            <a
                                                href="#"
